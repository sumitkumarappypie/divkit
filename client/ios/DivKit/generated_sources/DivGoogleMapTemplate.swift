...
public final class DivGoogleMapTemplate: TemplateValue, @unchecked Sendable {
  ...
  public let allowScroll: Field<Expression<Bool>>? // default value: true
  public let allowZoom: Field<Expression<Bool>>? // default value: true
  ...
  public let onReadyActions: Field<[DivActionTemplate]>?
  public let paddings: Field<DivEdgeInsetsTemplate>?
  public let reuseId: Field<Expression<String>>?
  public let rowSpan: Field<Expression<Int>>? // constraint: number >= 0
  public let selectedActions: Field<[DivActionTemplate]>?
  public let showUserLocation: Field<Expression<Bool>>? // default value: false
  ...
  public convenience init(dictionary: [String: Any], templateToType: [TemplateName: String]) throws {
    self.init(
      ...
      allowScroll: dictionary.getOptionalExpressionField("allow_scroll"),
      allowZoom: dictionary.getOptionalExpressionField("allow_zoom"),
      ...
      mapType: dictionary.getOptionalExpressionField("map_type"),
      margins: dictionary.getOptionalField("margins", templateToType: templateToType),
      markers: dictionary.getOptionalArray("markers", templateToType: templateToType),
      onErrorActions: dictionary.getOptionalArray("on_error_actions", templateToType: templateToType),
      onReadyActions: dictionary.getOptionalArray("on_ready_actions", templateToType: templateToType),
      ...
      showUserLocation: dictionary.getOptionalExpressionField("show_user_location"),
      ...
      zoom: dictionary.getOptionalExpressionField("zoom")
    )
  }
  ...
  init(
    ...
    allowScroll: Field<Expression<Bool>>? = nil,
    allowZoom: Field<Expression<Bool>>? = nil,
    ...
    onReadyActions: Field<[DivActionTemplate]>? = nil,
    paddings: Field<DivEdgeInsetsTemplate>? = nil,
    reuseId: Field<Expression<String>>? = nil,
    rowSpan: Field<Expression<Int>>? = nil,
    selectedActions: Field<[DivActionTemplate]>? = nil,
    showUserLocation: Field<Expression<Bool>>? = nil,
    ...
    zoom: Field<Expression<Double>>? = nil
  ) {
    self.parent = parent
  ...
  private static func resolveOnlyLinks(context: TemplatesContext, parent: DivGoogleMapTemplate?) -> DeserializationResult<DivGoogleMap> {
    ...
    let allowScrollValue = parent?.allowScroll?.resolveOptionalValue(context: context) ?? .noValue
    let allowZoomValue = parent?.allowZoom?.resolveOptionalValue(context: context) ?? .noValue
    ...
    let mapTypeValue = parent?.mapType?.resolveOptionalValue(context: context) ?? .noValue
    let marginsValue = parent?.margins?.resolveOptionalValue(context: context, useOnlyLinks: true) ?? .noValue
    let markersValue = parent?.markers?.resolveOptionalValue(context: context, useOnlyLinks: true) ?? .noValue
    let onErrorActionsValue = parent?.onErrorActions?.resolveOptionalValue(context: context, useOnlyLinks: true) ?? .noValue
    let onReadyActionsValue = parent?.onReadyActions?.resolveOptionalValue(context: context, useOnlyLinks: true) ?? .noValue
    ...
    let showUserLocationValue = parent?.showUserLocation?.resolveOptionalValue(context: context) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      allowScrollValue.errorsOrWarnings?.map { .nestedObjectError(field: "allow_scroll", error: $0) },
      allowZoomValue.errorsOrWarnings?.map { .nestedObjectError(field: "allow_zoom", error: $0) },
      ...
      mapTypeValue.errorsOrWarnings?.map { .nestedObjectError(field: "map_type", error: $0) },
      marginsValue.errorsOrWarnings?.map { .nestedObjectError(field: "margins", error: $0) },
      markersValue.errorsOrWarnings?.map { .nestedObjectError(field: "markers", error: $0) },
      onErrorActionsValue.errorsOrWarnings?.map { .nestedObjectError(field: "on_error_actions", error: $0) },
      onReadyActionsValue.errorsOrWarnings?.map { .nestedObjectError(field: "on_ready_actions", error: $0) },
      ...
      showUserLocationValue.errorsOrWarnings?.map { .nestedObjectError(field: "show_user_location", error: $0) },
      ...
      zoomValue.errorsOrWarnings?.map { .nestedObjectError(field: "zoom", error: $0) }
    )
    ...
    let result = DivGoogleMap(
      accessibility: accessibilityValue.value,
      alignmentHorizontal: alignmentHorizontalValue.value,
      alignmentVertical: alignmentVerticalValue.value,
      allowScroll: allowScrollValue.value,
      allowZoom: allowZoomValue.value,
      ...
      mapType: mapTypeValue.value,
      margins: marginsValue.value,
      markers: markersValue.value,
      onErrorActions: onErrorActionsValue.value,
      onReadyActions: onReadyActionsValue.value,
      paddings: paddingsValue.value,
      reuseId: reuseIdValue.value,
      rowSpan: rowSpanValue.value,
      selectedActions: selectedActionsValue.value,
      showUserLocation: showUserLocationValue.value,
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivGoogleMapTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivGoogleMap> {
    if useOnlyLinks {
    ...
    var allowScrollValue: DeserializationResult<Expression<Bool>> = parent?.allowScroll?.value() ?? .noValue
    var allowZoomValue: DeserializationResult<Expression<Bool>> = parent?.allowZoom?.value() ?? .noValue
    ...
    var onReadyActionsValue: DeserializationResult<[DivAction]> = .noValue
    ...
    var showUserLocationValue: DeserializationResult<Expression<Bool>> = parent?.showUserLocation?.value() ?? .noValue
    ...
    var zoomValue: DeserializationResult<Expression<Double>> = parent?.zoom?.value() ?? .noValue
    context.templateData.forEach { key, __dictValue in
      ...
      case "allow_scroll":
        allowScrollValue = deserialize(__dictValue).merged(with: allowScrollValue)
      case "allow_zoom":
        allowZoomValue = deserialize(__dictValue).merged(with: allowZoomValue)
      case "alpha":
      ...
      case "map_type":
        mapTypeValue = deserialize(__dictValue).merged(with: mapTypeValue)
      case "margins":
      ...
      case "markers":
        markersValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivGoogleMapMarkerTemplate.self).merged(with: markersValue)
      ...
      case "on_ready_actions":
        onReadyActionsValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivActionTemplate.self).merged(with: onReadyActionsValue)
      case "paddings":
      ...
      case "show_user_location":
        showUserLocationValue = deserialize(__dictValue).merged(with: showUserLocationValue)
      case "tooltips":
      ...
      case parent?.allowScroll?.link:
        allowScrollValue = allowScrollValue.merged(with: { deserialize(__dictValue) })
      case parent?.allowZoom?.link:
        allowZoomValue = allowZoomValue.merged(with: { deserialize(__dictValue) })
      ...
      case parent?.mapType?.link:
        mapTypeValue = mapTypeValue.merged(with: { deserialize(__dictValue) })
      ...
      case parent?.markers?.link:
        markersValue = markersValue.merged(with: { deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivGoogleMapMarkerTemplate.self) })
      ...
      case parent?.onReadyActions?.link:
        onReadyActionsValue = onReadyActionsValue.merged(with: { deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivActionTemplate.self) })
      ...
      case parent?.showUserLocation?.link:
        showUserLocationValue = showUserLocationValue.merged(with: { deserialize(__dictValue) })
    ...
    if let parent = parent {
      ...
      _ = markersValue = markersValue.merged(with: { parent.markers?.resolveOptionalValue(context: context, useOnlyLinks: true) })
      ...
      _ = onReadyActionsValue = onReadyActionsValue.merged(with: { parent.onReadyActions?.resolveOptionalValue(context: context, useOnlyLinks: true) })
  ...
  private func mergedWithParent(templates: [TemplateName: Any]) throws -> DivGoogleMapTemplate {
    guard let parent = parent, parent != Self.type else { return self }
    guard let parentTemplate = templates[parent] as? DivGoogleMapTemplate else {
      throw DeserializationError.unknownType(type: parent)
    }
    let mergedParent = try parentTemplate.mergedWithParent(templates: templates)

    return DivGoogleMapTemplate(
      parent: nil,
      accessibility: accessibility ?? mergedParent.accessibility,
      alignmentHorizontal: alignmentHorizontal ?? mergedParent.alignmentHorizontal,
      alignmentVertical: alignmentVertical ?? mergedParent.alignmentVertical,
      allowScroll: allowScroll ?? mergedParent.allowScroll,
      allowZoom: allowZoom ?? mergedParent.allowZoom,
      ...
      mapType: mapType ?? mergedParent.mapType,
      margins: margins ?? mergedParent.margins,
      markers: markers ?? mergedParent.markers,
      onErrorActions: onErrorActions ?? mergedParent.onErrorActions,
      onReadyActions: onReadyActions ?? mergedParent.onReadyActions,
      paddings: paddings ?? mergedParent.paddings,
      reuseId: reuseId ?? mergedParent.reuseId,
      rowSpan: rowSpan ?? mergedParent.rowSpan,
      selectedActions: selectedActions ?? mergedParent.selectedActions,
      showUserLocation: showUserLocation ?? mergedParent.showUserLocation,
      ...
      zoom: zoom ?? mergedParent.zoom
    )
  }

  public func resolveParent(templates: [TemplateName: Any]) throws -> DivGoogleMapTemplate {
    ...
    return DivGoogleMapTemplate(
      ...
      allowScroll: merged.allowScroll,
      allowZoom: merged.allowZoom,
      alpha: merged.alpha,
      ...
      mapType: merged.mapType,
      margins: merged.margins?.tryResolveParent(templates: templates),
      markers: merged.markers?.tryResolveParent(templates: templates),
      onErrorActions: merged.onErrorActions?.tryResolveParent(templates: templates),
      onReadyActions: merged.onReadyActions?.tryResolveParent(templates: templates),
      paddings: merged.paddings?.tryResolveParent(templates: templates),
      reuseId: merged.reuseId,
      rowSpan: merged.rowSpan,
      selectedActions: merged.selectedActions?.tryResolveParent(templates: templates),
      showUserLocation: merged.showUserLocation,
