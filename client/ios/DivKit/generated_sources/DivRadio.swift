...
public final class DivRadio: DivBase, Sendable {
  @frozen
  ...
  static let optionsValidator: AnyArrayValueValidator<DivRadio.Option> =
  ...
  public convenience init(dictionary: [String: Any], context: ParsingContext) throws {
    self.init(
      ...
      options: try dictionary.getArray("options", transform: { (dict: [String: Any]) in try? DivRadio.Option(dictionary: dict, context: context) }, validator: Self.optionsValidator, context: context),
...
#if DEBUG
extension DivRadio: Equatable {
  public static func ==(lhs: DivRadio, rhs: DivRadio) -> Bool {
    guard
...
extension DivRadio: Serializable {
  @_optimize(size)
...
#if DEBUG
extension DivRadio.Option: Equatable {
  public static func ==(lhs: DivRadio.Option, rhs: DivRadio.Option) -> Bool {
    guard
      lhs.text == rhs.text,
      lhs.value == rhs.value
    else {
...
extension DivRadio.Option: Serializable {
  @_optimize(size)
  public func toDictionary() -> [String: ValidSerializationValue] {
    var result: [String: ValidSerializationValue] = [:]
