...
public final class DivRadioTemplate: TemplateValue, Sendable {
  public final class OptionTemplate: TemplateValue, Sendable {
    ...
    private static func resolveOnlyLinks(context: TemplatesContext, parent: OptionTemplate?) -> DeserializationResult<DivRadio.Option> {
    ...
    public static func resolveValue(context: TemplatesContext, parent: OptionTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivRadio.Option> {
      if useOnlyLinks {
  ...
  public typealias Orientation = DivRadio.Orientation

  public static let type: String = "radio"
  ...
  private static func resolveOnlyLinks(context: TemplatesContext, parent: DivRadioTemplate?) -> DeserializationResult<DivRadio> {
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivRadioTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivRadio> {
    if useOnlyLinks {
      return resolveOnlyLinks(context: context, parent: parent)
    }
    ...
    var optionsValue: DeserializationResult<[DivRadio.Option]> = .noValue
    var orientationValue: DeserializationResult<Expression<DivRadio.Orientation>> = parent?.orientation?.value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "options":
        optionsValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, validator: ResolvedValue.optionsValidator, type: DivRadioTemplate.OptionTemplate.self).merged(with: optionsValue)
      case "orientation":
      ...
      case parent?.options?.link:
        optionsValue = optionsValue.merged(with: { deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, validator: ResolvedValue.optionsValidator, type: DivRadioTemplate.OptionTemplate.self) })
  ...
  private func mergedWithParent(templates: [TemplateName: Any]) throws -> DivRadioTemplate {
    guard let parent = parent, parent != Self.type else { return self }
    guard let parentTemplate = templates[parent] as? DivRadioTemplate else {
  ...
  public func resolveParent(templates: [TemplateName: Any]) throws -> DivRadioTemplate {
