...
public final class DivCheckboxTemplate: TemplateValue, Sendable {
  public static let type: String = "checkbox"
  ...
  public let isCheckedVariable: Field<String>?
  ...
  public convenience init(dictionary: [String: Any], templateToType: [TemplateName: String]) throws {
    self.init(
      ...
      checkMarkColor: dictionary.getOptionalExpressionField("check_mark_color", transform: Color.color(withHexString:)),
      ...
      isCheckedVariable: dictionary.getOptionalField("is_checked_variable"),
      ...
      offColor: dictionary.getOptionalExpressionField("off_color", transform: Color.color(withHexString:)),
  ...
  init(
    ...
    checkMarkColor: Field<Expression<Color>>? = nil,
    ...
    self.height = height
    self.id = id
    self.isCheckedVariable = isCheckedVariable
  ...
  private static func resolveOnlyLinks(context: TemplatesContext, parent: DivCheckboxTemplate?) -> DeserializationResult<DivCheckbox> {
    ...
    let checkMarkColorValue = parent?.checkMarkColor?.resolveOptionalValue(context: context, transform: Color.color(withHexString:)) ?? .noValue
    ...
    let isCheckedVariableValue = parent?.isCheckedVariable?.resolveValue(context: context) ?? .noValue
    ...
    let offColorValue = parent?.offColor?.resolveOptionalValue(context: context, transform: Color.color(withHexString:)) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      checkMarkColorValue.errorsOrWarnings?.map { .nestedObjectError(field: "check_mark_color", error: $0) },
      ...
      isCheckedVariableValue.errorsOrWarnings?.map { .nestedObjectError(field: "is_checked_variable", error: $0) },
      ...
      offColorValue.errorsOrWarnings?.map { .nestedObjectError(field: "off_color", error: $0) },
    ...
    if case .noValue = isCheckedVariableValue {
      errors.append(.requiredFieldIsMissing(field: "is_checked_variable"))
    }
    guard
      let isCheckedVariableNonNil = isCheckedVariableValue.value
    else {
      return .failure(NonEmptyArray(errors)!)
    }
    let result = DivCheckbox(
      ...
      checkMarkColor: checkMarkColorValue.value,
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivCheckboxTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivCheckbox> {
    if useOnlyLinks {
    ...
    var checkMarkColorValue: DeserializationResult<Expression<Color>> = parent?.checkMarkColor?.value() ?? .noValue
    ...
    var isCheckedVariableValue: DeserializationResult<String> = parent?.isCheckedVariable?.value() ?? .noValue
    ...
    var offColorValue: DeserializationResult<Expression<Color>> = parent?.offColor?.value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "check_mark_color":
        checkMarkColorValue = deserialize(__dictValue, transform: Color.color(withHexString:)).merged(with: checkMarkColorValue)
      case "column_span":
      ...
      case "is_checked_variable":
        isCheckedVariableValue = deserialize(__dictValue).merged(with: isCheckedVariableValue)
      case "is_enabled":
      ...
      case "off_color":
        offColorValue = deserialize(__dictValue, transform: Color.color(withHexString:)).merged(with: offColorValue)
      case "on_color":
      ...
      case parent?.checkMarkColor?.link:
        checkMarkColorValue = checkMarkColorValue.merged(with: { deserialize(__dictValue, transform: Color.color(withHexString:)) })
      ...
      case parent?.isCheckedVariable?.link:
        isCheckedVariableValue = isCheckedVariableValue.merged(with: { deserialize(__dictValue) })
      ...
      case parent?.offColor?.link:
        offColorValue = offColorValue.merged(with: { deserialize(__dictValue, transform: Color.color(withHexString:)) })
  ...
  private func mergedWithParent(templates: [TemplateName: Any]) throws -> DivCheckboxTemplate {
    guard let parent = parent, parent != Self.type else { return self }
    guard let parentTemplate = templates[parent] as? DivCheckboxTemplate else {
      throw DeserializationError.unknownType(type: parent)
    }
    let mergedParent = try parentTemplate.mergedWithParent(templates: templates)

    return DivCheckboxTemplate(
      parent: nil,
      ...
      checkMarkColor: checkMarkColor ?? mergedParent.checkMarkColor,
  ...
  public func resolveParent(templates: [TemplateName: Any]) throws -> DivCheckboxTemplate {
    ...
    return DivCheckboxTemplate(
      ...
      checkMarkColor: merged.checkMarkColor,
