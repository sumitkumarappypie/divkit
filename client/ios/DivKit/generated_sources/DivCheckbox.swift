...
public final class DivCheckbox: DivBase, Sendable {
  ...
  public let isCheckedVariable: String
  ...
  public convenience init(dictionary: [String: Any], context: ParsingContext) throws {
    self.init(
      ...
      checkMarkColor: try dictionary.getOptionalExpressionField("check_mark_color", transform: Color.color(withHexString:), context: context),
      ...
      isCheckedVariable: try dictionary.getField("is_checked_variable", context: context),
      ...
      offColor: try dictionary.getOptionalExpressionField("off_color", transform: Color.color(withHexString:), context: context),
  ...
  init(
    ...
    checkMarkColor: Expression<Color>? = nil,
...
#if DEBUG
extension DivCheckbox: Equatable {
  public static func ==(lhs: DivCheckbox, rhs: DivCheckbox) -> Bool {
    guard
    ...
    guard
      lhs.isCheckedVariable == rhs.isCheckedVariable,
...
extension DivCheckbox: Serializable {
  @_optimize(size)
  public func toDictionary() -> [String: ValidSerializationValue] {
    ...
    result["id"] = id
    result["is_checked_variable"] = isCheckedVariable
